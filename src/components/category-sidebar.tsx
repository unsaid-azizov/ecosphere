      ...
      <div className="lg:hidden">
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="categories" className="border-forest-200">
            <AccordionTrigger className="hover:no-underline text-forest-800 font-semibold">
          ...
          <div className="lg:hidden mt-4">
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="filters" className="border-forest-200">
                <AccordionTrigger className="hover:no-underline text-forest-800 font-semibold py-3">
                  <div className="flex items-center gap-2">
                    <Filter className="h-4 w-4" />
